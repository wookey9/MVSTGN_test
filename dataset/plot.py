...
for index in range(4,11):
    sliceSum2 = pd.read_csv('mobile_dataset/sms-call-internet-mi-2013-11-'+str(index).zfill(2) +'.txt', sep='\t', encoding="utf-8-sig", names=['CellID', 'datetime', 'countrycode', 'smsin', 'smsout', 'callin', 'callout', 'internet'], parse_dates=['datetime'], date_parser=parse)
    ...
    sliceSum = pd.concat([sliceSum,sliceSum2])
